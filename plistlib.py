...
class Plist(_InternalDict):
    ...
    def __init__(self, **kwargs):
        warn(
            "The Plist class is deprecated, use the load() and "
            "dump() functions instead",
            DeprecationWarning,
            2,
        )
        super().__init__(**kwargs)
...
class _BinaryPlistParser:
    ...
    def _read_object(self, offset):
        ...
        # UUID (0x0e), but neither can be generated using the Cocoa libraries.
            ...
            return int.from_bytes(self._fp.read(1 << tokenL), "big", signed=tokenL >= 3)
        ...
        # plists.
            ...
            for k, o in zip(key_refs, obj_refs):
                result[self._read_object(self._object_offsets[k])] = self._read_object(
                    self._object_offsets[o]
                )
            return result
...
class _BinaryPlistWriter(object):
    ...
    def _flatten(self, value):
        ...
        if isinstance(value, (str, int, float, datetime.datetime, bytes, bytearray)):
